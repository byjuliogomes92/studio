...
exports.setAdminClaim = functions.https.onCall(async (data, context) => {
  ...
  try {
    ...
    // Also update the 'users' collection for client-side visibility if needed.
...
exports.getAllUsers = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        // Here you could fetch additional data from Firestore for each user if needed,
        // for example, the number of projects or workspaces they belong to.
